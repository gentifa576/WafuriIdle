...
| Combat wipe recovery | When every combat member reaches `0 HP`, combat enters `DOWN` for `30s`, then the team revives at `50%` HP and combat resumes against a fresh full-HP enemy. |
